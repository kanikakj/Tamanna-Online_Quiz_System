...
<head>
    ...
    <title>Dashboard | TAMANNA Quiz System</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   echo '<h1 style="text-align:center;"><p style="color: white ; "><strong><sub>Welcome , Admin !</sub></strong></p></h1>';
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        ...
                        <tr><td><center><b>S.N.</b></center></td><td><center><b>Name</b></center></td><td><center><b>School Name</b></center></td><td><center><b>Email</b></center></td><td><center><b>Action</b></center></td></tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            $email = $row['email'];
                            $school = $row['school_name'];
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$name.'</center></td><td><center>'.$school.'</center></td><td><center>'.$email.'</center></td><td><center><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
                ...
                <?php
                    if(@$_GET['q']==4 && !(@$_GET['step']) ) 
                    {
                        ...
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:White;"> <b>Enter Quiz Details</b></span><br /><br/>
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="right" name="right_answer_score" placeholder="Enter marks on right answer" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            $eid = $row['eid'];
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$title.'</center></td><td><center>'.$total.'</center></td><td><center>'.$right_answer_score*$total.'</center></td>
